...
INSERT INTO `Platnosc` VALUES (1,'platnosc'),(3,'platnosc'),(4,'platnosc'),(5,'platnosc'),(6,'platnosc'),(7,'platnosc');
...
INSERT INTO `Produkty` VALUES (1,1,'Kustosz',1.69,'dobre, tanie, wykwintne piwo',5,4),(2,1,'Amarena',1.69,'dobre, tanie, wykwintne wino',1,2);
...
INSERT INTO `Status_zamowienia` VALUES (1,'2018-01-12 19:54:18','nieprzygotowany'),(3,'2018-01-12 19:54:45','nieprzygotowany'),(4,'2018-01-12 20:17:08','nieprzygotowany'),(5,'2018-01-12 20:40:59','nieprzygotowany'),(6,'2018-01-12 21:44:34','nieprzygotowany'),(7,'2018-01-13 13:54:45','nieprzygotowany');
...
INSERT INTO `Wysylka` VALUES (1,9.5,'kurier'),(3,9.5,'kurier'),(4,9.5,'kurier'),(5,9.5,'kurier'),(6,9.5,'kurier'),(7,9.5,'kurier');
...
INSERT INTO `Zamowienia` VALUES (2,1,1,1,'2018-01-12 19:54:18',1,1,3,3,0),(3,1,3,3,'2018-01-12 19:54:45',1,1,3,3,0),(4,1,4,4,'2018-01-12 20:17:08',1,2,6,3,0),(5,1,5,5,'2018-01-12 20:40:59',2,10,30,3,0),(6,1,6,6,'2018-01-12 21:44:34',1,3,9,3,0),(7,1,7,7,'2018-01-13 13:54:45',1,1,3,3,0);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertZamowienia`(IDk INT, IDprod INT, amount INT, sum FLOAT, payment INT, paper BOOLEAN, sendSum FLOAT, descrW TEXT, descrT VARCHAR(50))
BEGIN
    ...
    INSERT INTO `Zamowienia` (`ID_Klient`, `ID_Platnosci`, `ID_Wysylki`, `ID_Produnkt`,`ilosc`, `koszt`,`platnosc`,`faktura`) VALUES
      (IDk,id,id,IDprod,amount,sum,payment,paper);
...
-- Dump completed on 2018-01-13 15:00:20
